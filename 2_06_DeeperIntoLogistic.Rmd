...
# Instructor Notes: Deeper into Logistic Growth
...
- **Clarify the Relationship Between Exponential and Logistic Growth**: Make sure students understand how the logistic model becomes the exponential model when $K$ is removed.
